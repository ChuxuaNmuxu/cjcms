...
test('test getChildrendIds', () => {
    expect(nodeHelper.getChildrenIds(hamster, '7')).toEqual(Immutable.List(['7']))
})
...
test('test getLeafIds', () => {
    ...
    expect(nodeHelper.getLeafIds(hamster, '7')).toEqual(Immutable.List('7'))
    expect(nodeHelper.getLeafIds(hamster, '8')).toEqual(Immutable.List())
})
...
test('test getAllLeafIds', () => {
    ...
    expect(nodeHelper.getAllLeafIds(hamster, '1')).toEqual(Immutable.List(['4', '5', '6']))
